...
/* package thesis-implementation-0.1.0.0 */
#define VERSION_thesis_implementation "0.1.0.0"
#define MIN_VERSION_thesis_implementation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "thesis-implementation-0.1.0.0-GUbqbo3VjlH1F8Fs5xdgQU"

#define CURRENT_PACKAGE_KEY "thesis-implementation-0.1.0.0-GUbqbo3VjlH1F8Fs5xdgQU"
